...
public class SharePictureTab extends Fragment implements View.OnClickListener{
       ...
       switch (view.getId())
       {
           ...
           case R.id.btnShareImage:
               ...
               if(receivedImageBitmap != null)
               {
                  ...
                  {
                      FancyToast.makeText(getContext(),"Error: debes poner una descripción.",
                  ...
                  else
                  {
                      ...
                      parseObject.saveInBackground(new SaveCallback() {
                          ...
                          public void done(ParseException e)
                          {
                             if( e == null)
                             {
                                 FancyToast.makeText(getContext(),"Listo !!!",
                                         Toast.LENGTH_LONG,FancyToast.SUCCESS,true).show();
                             }
                             else
                             {
                                 FancyToast.makeText(getContext(),"Error desconocido: " +e.getMessage(),
                                         Toast.LENGTH_LONG,FancyToast.ERROR,true).show();
                             }
               ...
               {
                   FancyToast.makeText(getContext(),"Error: debes seleccionar una imagen.",
                           Toast.LENGTH_LONG,FancyToast.ERROR,true).show();
               }
               break;
       }
    ...
    {
        FancyToast.makeText(getContext(), "Ahora podemos acceder a las imágenes...",
